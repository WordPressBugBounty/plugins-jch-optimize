...
class Inflector extends DoctrineInflector
{
     ...
     * @since  2.0.0
     */
    private static $countable = ['rules' => ['id', 'hits', 'clicks']];
    /**
    ...
    {
        trigger_deprecation('joomla/string', '2.0.0', '%s() is deprecated and will be removed in 3.0, use %s::rules() instead.', __METHOD__, DoctrineInflector::class);
        if ($plural !== '') {
            static::rules('plural', ['irregular' => [$plural => $singular]]);
            static::rules('singular', ['irregular' => [$singular => $plural]]);
        } else {
            static::rules('plural', ['uninflected' => [$singular]]);
            static::rules('singular', ['uninflected' => [$singular]]);
        }
        return $this;
    }
    /**
    ...
    {
        trigger_deprecation('joomla/string', '2.0.0', '%s() is deprecated and will be removed in 3.0.', __METHOD__);
        if ($new) {
            return new static();
        }
    ...
    {
        trigger_deprecation('joomla/string', '2.0.0', '%s() is deprecated and will be removed in 3.0, use %s::pluralize() instead.', __METHOD__, DoctrineInflector::class);
    ...
    {
        trigger_deprecation('joomla/string', '2.0.0', '%s() is deprecated and will be removed in 3.0, use %s::singularize() instead.', __METHOD__, DoctrineInflector::class);
