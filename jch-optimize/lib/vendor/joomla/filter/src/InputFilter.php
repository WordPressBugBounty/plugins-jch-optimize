...
class InputFilter
{
     ...
     * @since  1.0
     */
    public $blockedTags = ['applet', 'body', 'bgsound', 'base', 'basefont', 'canvas', 'embed', 'frame', 'frameset', 'head', 'html', 'id', 'iframe', 'ilayer', 'layer', 'link', 'meta', 'name', 'object', 'script', 'style', 'title', 'xml'];
    /**
     ...
     * @since  1.3.3
     */
    private $blockedChars = ['&tab;', '&space;', '&colon;', '&column;'];
    /**
