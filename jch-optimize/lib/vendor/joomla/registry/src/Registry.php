...
class Registry implements \JsonSerializable, \ArrayAccess, \IteratorAggregate, \Countable
{
     ...
     * @since   1.0.0
     */
    protected function bindData($parent, $data, $recursive = \true, $allowNull = \true)
    {
    ...
    public function __get($name)
    {
        switch ($name) {
            ...
            default:
                ...
                \trigger_error(\sprintf('Undefined property via __get(): %1$s in %2$s on line %3$s', $name, $trace[0]['file'], $trace[0]['line']), \E_USER_NOTICE);
                return null;
        }
    }
    /**
