...
<div class="container-fluid grid box-sizing-border-box">
    <div class="g-col-2 g-col-lg-1 box-sizing-border-box">
        <div class="card">
            <div class="card-header fs-5 py-3">
                    <span class="fa fa-file-download me-2"></span>
                    <?= __('Optimize Files Automatic Settings', 'jch-optimize') ?>
            </div>
            <div class="card-body">
    ...
    <div class="g-col-2 g-col-lg-1 box-sizing-border-box">
        <div class="card">
            <div class="card-header fs-5 py-3">
                <span class="fa fa-exclamation-circle me-2"></span><?= __('Notifications', 'jch-optimize') ?>
            </div>
            <div class="card-body">
                <nav class="jch-dash-icons p-3">
                    <ul class="nav d-grid flex-wrap m-0">
    ...
    <div class="g-col-2 g-col-lg-1 box-sizing-border-box">
        <div class="card">
            <div class="card-header fs-5 py-3">
                <span class="fa fa-tasks me-2"></span> <?= __('Utility Tasks', 'jch-optimize') ?>
            </div>
            <div class="card-body">
                <nav class="jch-dash-icons p-3">
                    <ul class="nav d-grid flex-wrap m-0">
    ...
    <div class="g-col-2 g-col-lg-1 box-sizing-border-box">
        <div class="card">
            <div class="card-header fs-5 py-3">
                <span class="fa fa-image me-2"></span> <?= __('Image/CDN Features', 'jch-optimize') ?>
            </div>
            <div class="card-body">
                <nav class="jch-dash-icons p-3">
                    <ul class="nav d-grid flex-wrap m-0">
    ...
    <div class="g-col-2 g-col-lg-1 box-sizing-border-box">
        <div class="card">
            <div class="card-header fs-5 py-3">
                <span class="fa fa-users-cog me-2"></span> <?= __('Advanced Features', 'jch-optimize') ?>
            </div>
            <div class="card-body">
                <nav class="jch-dash-icons p-3">
                    <ul class="nav d-grid flex-wrap m-0">
    ...
    <div class="g-col-2 g-col-lg-1 box-sizing-border-box">
        <div class="card">
            <div class="card-header fs-5 py-3">
                <span class="fa fa-css3-alt me-2"></span> <?= __('CSS Features', 'jch-optimize') ?>
            </div>
            <div class="card-body">
                <nav class="jch-dash-icons p-3">
                    <ul class="nav d-grid flex-wrap m-0">
    ...
    <div class="g-col-2 g-col-lg-1 box-sizing-border-box">
        <div class="card">
            <div class="card-header fs-5 py-3">
                <span class="fa fa-copyright me-2"></span> <?= __('Copyright Info') ?>
            </div>
    ...
    <li class="list-group-item">
        <div class="d-flex justify-content-between align-items-center">
           <div class="jchsupportinfo__optimize-desc">
            ...
            <a href="https://www.jch-optimize.net/subscribes/subscribe-wordpress/wordpress-optimize/optimize-services-for-wordpress-article.html"
